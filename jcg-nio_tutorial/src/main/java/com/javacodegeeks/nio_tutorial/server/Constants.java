...
public final class Constants {
    ...
    public static final String TEXT_FIRST_SEGMENT = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis urna augue, "
            ...
            + "Etiam ullamcorper, justo eu consequat tempor, tortor libero blandit turpis, eu pharetra lectus sapien vitae turpis. " + "Ut tincidunt consequat urna sed dignissim.";

    public static final String TEXT_SECOND_SEGMENT = "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis urna augue, "
            + "porta vitae erat quis, tempus dignissim urna. Maecenas ornare vel nibh eget fringilla. "
            + "Quisque ac ullamcorper diam. Vestibulum maximus molestie ex non convallis. Cras id lacinia magna. "
            + "Phasellus finibus turpis erat, id finibus est blandit a. Integer accumsan est metus, eu placerat dui congue et. "
            + "Phasellus sed fringilla orci. Nullam aliquet sem sed eros commodo, eget convallis ipsum tristique. "
